...
class Module:
    ...
    def matmul(A: T.handle, B: T.handle, C_handle: T.handle):
        ...
        with T.block("tilelang_root"):
            ...
            for k in T.serial(32, annotations={"software_pipeline_async_producer_groups": [0, 0, -1], "software_pipeline_async_producers": [1, 1, 0], "software_pipeline_async_stages": [0], "software_pipeline_order": [0, 1, 2], "software_pipeline_stage": [0, 0, 2], "software_pipeline_tma_copies": [0, 0, 0], "tl_pipelined_num_stages": 3}):
